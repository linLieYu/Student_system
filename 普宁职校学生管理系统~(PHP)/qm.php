    ...
    <?php
      ...
      if(isset($_SESSION['ok'])&&$_SESSION['ok']==1){
        ...
        if(isset($_POST['tianjia'])){
          $tianjia="INSERT INTO student_qm(name,qm_chinese,qm_math,qm_english,qm_flash,qm_tiyu,qm_music,qm_jichu,qm_c)VALUES
                      ...
                      <section class="panel">
                          ...
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <tr>
                                  ...
                                  <form action="qm.php" method="post">
                                ...
                                <?php
                                  while($array = mysqli_fetch_array($r1)){
                                    echo "<tr x-id=".$array['id'].">
                                          ...
                                          <td>".$array['id']."</td>
                                          <td>".$array['name']."</td>
                                          <td>".$array['qm_chinese']."</td>
                                          <td>".$array['qm_math']."</td>
                                          <td>".$array['qm_english']."</td>
                                          <td>".$array['qm_c']."</td>
                                          <td>".$array['qm_flash']."</td>
                                          <td>".$array['qm_music']."</td>
                                          <td>".$array['qm_tiyu']."</td>
                                          <td>".$array['qm_jichu']."</td>
                                        <td>
    ...
    <script type="text/javascript">
          ...
          var jtext = nodes[9].innerText;
            ...
            //10
						...
						isEdit = $.ajax({data: {id: this.parentNode.parentNode.getAttribute('x-id'),itext:itext,ntext: ntext, cntext: cntext,mtext: mtext,etext: etext,ctext: ctext,ftext: ftext,musictext: musictext,ttext: ttext,jtext: jtext },type:'POST',url:"ajax.php",async:false});
